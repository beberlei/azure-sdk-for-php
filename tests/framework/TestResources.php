...
class TestResources
{
    ...
    public static function simplePackageUrl()
    {
        ...
        if (empty($name)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_SIMPLE_PACKAGE_URL envionment variable is missing');
        }
    ...
    public static function simplePackageConfiguration()
    {
        ...
        if (empty($name)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_SIMPLE_PACKAGE_CONFIGURATION envionment variable is missing');
        }
    ...
    public static function complexPackageUrl()
    {
        ...
        if (empty($name)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_COMPLEX_PACKAGE_URL envionment variable is missing');
        }
    ...
    public static function complexPackageConfiguration()
    {
        ...
        if (empty($name)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_COMPLEX_PACKAGE_CONFIGURATION envionment variable is missing');
        }
    ...
    public static function accountName()
    {
        ...
        if (empty($name)) {
            throw new \PHPUnit_Framework_SkippedTestError('AZURE_STORAGE_ACCOUNT envionment variable is missing');
        }
    ...
    public static function accountKey()
    {
        ...
        if (empty($key)) {
            throw new \PHPUnit_Framework_SkippedTestError('AZURE_STORAGE_KEY envionment variable is missing');
        }
    ...
    public static function serviceManagementSubscriptionId()
    {
        ...
        if (empty($subscriptionId)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_SUBSCRIPTION_ID envionment variable is missing');
        }
    ...
    public static function serviceManagementCertificatePath()
    {
        ...
        if (empty($path)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_MANAGEMENT_CERTIFICATE_PATH envionment variable is missing');
        }
    ...
    public static function serviceBusNamespace()
    {
        ...
        if (empty($namespace)) {
            throw new \PHPUnit_Framework_SkippedTestError('SERVICE_BUS_NAMESPACE enviroment variable is missing.');
        }
    ...
    public static function wrapAuthenticationName()
    {
        ...
        if (empty($wrapAuthenticationName)) {
            throw new \PHPUnit_Framework_SkippedTestError('WRAP_AUTHENTICATION_NAME enviroment variable is missing.');
        }
    ...
    public static function wrapPassword()
    {
        ...
        if (empty($wrapPassword)) {
            throw new \PHPUnit_Framework_SkippedTestError('WRAP_PASSWORD enviroment variable is missing.');
        }
